...
$.ajax({
type: 'POST',
url: '../../exynghjkilopvbcdfghmijhgfdsertwawqsxcvbnmkliop/views/add-new-lecturer.php',
data: {
...
document.getElementById("message").innerHTML = "password is:" + " " + password;
 setTimeout(function(){
              if(window.location.pathname != "/exynghjkilopvbcdfghmijhgfdsertwawqsxcvbnmkliop/all_lecturers.php") {
