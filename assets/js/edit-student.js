...
console.log( $("#editwebForm #session").val(),  $("#editwebForm #semester").val()); 
//console.log(data);
...
$.ajax({
type: 'POST',
url: '../../exynghjkilopvbcdfghmijhgfdsertwawqsxcvbnmkliop/views/edit-new-user.php',
data: {
'userid': $("#editwebForm #userid").val(),
'firstname': $("#editwebForm #firstname").val(),
'lastname': $("#editwebForm #lastname").val(),       
'email': $("#editwebForm #email").val(),
'regno': $("#editwebForm #regno").val(),
'phone': $("#editwebForm #phone").val(),
'session': $("#editwebForm #session").val(),
'gender': $("#editwebForm #gender").val(),
'semester': $("#editwebForm #semester").val(),
'level': $("#editwebForm #level").val(),
},
beforeSend: function() {
